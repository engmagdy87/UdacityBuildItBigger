...
class EndpointsAsyncTask extends AsyncTask<com.udacity.gradle.builditbigger.free.MainActivityFragment, Void, String> {
    private static MyApi myApiService = null;
    private com.udacity.gradle.builditbigger.free.MainActivityFragment mainActivityFragment;
    private Context context;

    @Override
    protected String doInBackground(com.udacity.gradle.builditbigger.free.MainActivityFragment... params) {
